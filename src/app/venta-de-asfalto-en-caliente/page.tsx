...
export default function AsfaltoCalientePage() {
  ...
  const waUrl = "https://wa.me/51916764520?text=Solicito%20informacion%20del%20productos%20de%20Venta%20de%20Asfalto%20en%20Caliente"
  ...
  return (
    <div className="bg-background" ref={containerRef}>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-4 border-primary/20 hover:border-primary transition-all duration-500 group">
              <Image
                src="/asfaltos/asfalto_caliente.webp"
            ...
            <div className="space-y-6">
              <h2 className="text-3xl lg:text-4xl font-black uppercase tracking-tight text-primary info-reveal">VENTA DE ASFALTO EN CALIENTE</h2>
              <p className="text-muted-foreground leading-relaxed text-lg info-reveal">
                ...
                Es la mezcla asfáltica de mayor durabilidad, fabricada con agregados pétreos y cemento asfáltico PEN 60/70 a temperaturas superiores a los 150°C. Su aplicación in situ garantiza una compactación milimétrica y una superficie de rodadura de alta resistencia.
              </p>
              <div className="p-6 rounded-2xl bg-card border border-border info-reveal">
                <p className="text-sm font-medium italic">
                  "Solución de ingeniería definitiva para vías de alto tráfico y proyectos de infraestructura mayor."
                </p>
              </div>
              ...
              <div className="info-reveal">
                <ProductCTA 
                  whatsappUrl={waUrl} 
                  productName="Asfalto en Caliente"
                  info="Garantizamos mezclas asfálticas en caliente bajo normas MTC, asegurando la granulometría y temperatura exactas para su obra."
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
               <div className="space-y-4">
                 ...
                 <div className="aspect-square relative rounded-2xl overflow-hidden">
                   <Image src="/asphalt_workers_premium_1775080184201.webp" alt="Obra 2" fill className="object-cover" />
                 </div>
               </div>
               <div className="space-y-4 pt-12">
                 <div className="aspect-square relative rounded-2xl overflow-hidden">
                   <Image src="/asfalto_hero1.webp" alt="Obra 3" fill className="object-cover" />
                 </div>
                 <div className="aspect-[4/5] relative rounded-2xl overflow-hidden border border-primary/30">
                   <Image src="/asfaltos/FONDOS_ASFALTOS/ASFALTOS_FONDOS2.webp" alt="Sello" fill className="object-cover" />
                 </div>
               </div>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-40 bg-primary reveal-section overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-primary-foreground/80 text-lg lg:text-xl mb-12 max-w-2xl mx-auto font-medium">
            Suministramos Mezcla Asfáltica en Caliente con riguroso control de calidad y temperatura.
          </p>
          <Button
            asChild
            size="lg"
      ...
      <RelatedProducts currentProductId={5} />
