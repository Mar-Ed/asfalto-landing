...
export default function AsfaltoPENPage() {
  ...
  const waUrl = "https://wa.me/51901080254?text=Solicito%20informacion%20del%20productos%20de%20Venta%20de%20Asfalto%20PEN%20(Penetraci%C3%B3n)"
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center hero-content">
            ...
            >
              ...
              Cemento Asfáltico de Alta Resistencia
            </motion.div>
            
            <h1 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter mb-8 leading-[0.9]">
              Asfalto <span className="text-primary">PEN</span>: El Corazón de la Estructura Vial
            </h1>
      ...
      <section className="py-20 lg:py-32 reveal-section">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Alta Viscosidad", desc: "Proporciona una cohesión excepcional entre los agregados pétreos.", icon: Droplets },
              { title: "Resiliencia Térmica", desc: "No se deforma con calor extremo ni se fisura con el frío.", icon: Thermometer },
              { title: "Pureza Superior", desc: "Libre de impurezas químicas, asegurando larga vida útil.", icon: ShieldCheck },
              { title: "Impermeabilidad", desc: "Barrera natural absoluta contra la infiltración de agua.", icon: Waves }
            ].map((prop, idx) => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h2 className="text-4xl lg:text-5xl font-black uppercase tracking-tighter leading-none">
                Usos <span className="text-primary text-stroke-white">Industriales</span>
              </h2>
              <p className="text-background/70 text-lg">
                El Asfalto PEN es el componente primario para las soluciones viales más exigentes:
              </p>
              
              <ul className="space-y-4">
                {[
                  "Producción de Mezcla Asfáltica en Caliente (Autopistas)",
                  "Fabricación de Emulsiones Catiónicas y Aniónicas",
                  "Materia prima para Membranas y Mantos",
                  "Recubrimientos Industriales Anticorrosivos",
              ...
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                <div className="flex gap-4 items-center">
                  ...
                  <p className="text-sm">
                    <strong className="text-primary uppercase tracking-wider block mb-1">Garantía de Calidad:</strong>
                    Suministramos asfalto que cumple estrictamente con las Normas Técnicas Peruanas para asegurar la rentabilidad de su inversión.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl">
                <Image src="/TRABAJANDO_aSFALTO.jpg" alt="Obra Asfalto PEN" fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute bottom-6 left-6">
                  <p className="text-white font-black uppercase tracking-widest text-sm">Proyectos de Gran Envergadura</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden border-2 border-primary">
                  <Image src="/logo_oficial.png" alt="Sello Calidad" fill className="object-contain p-4" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-32 reveal-section">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">Logística adaptada a la escala de su necesidad.</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              { name: "Cilindro", size: "55 Galones", ideal: "Transporte y almacenamiento seguro", icon: Package },
              { name: "Granel", size: "Cisterna", ideal: "Entrega directa con calentamiento", icon: Truck }
            ].map((p, idx) => (
      ...
      <section className="py-20 lg:py-40 bg-primary reveal-section overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl lg:text-7xl font-black uppercase text-primary-foreground mb-8 tracking-tighter leading-none">
            El ligante que su obra necesita
          </h2>
          <p className="text-primary-foreground/80 text-lg lg:text-xl mb-12 max-w-2xl mx-auto font-medium">
            Despachamos Asfalto PEN de la mejor calidad. Asegure la durabilidad de sus pavimentos hoy mismo.
          </p>
          <Button
            asChild
            size="lg"
