...
import { Droplets, Timer, ShieldCheck, CheckCircle2, Factory, Truck, Package, Box, Waves, Leaf, Settings2, BarChart3, ClipboardCheck, Scale, Hammer, Zap, Anchor, ThermometerSun, ShieldAlert, Bug } from "lucide-react"
  ...
  return (
    <div className="bg-background" ref={containerRef}>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center hero-content">
            ...
            >
              ...
              Protección Profunda y Sellado Hidrófugo
            </motion.div>
            
            <h1 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter mb-8 leading-[0.9]">
              Alquitrán <span className="text-primary">Refinado</span>: Barrera Contra Corrosión
            </h1>
            
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed mb-10 max-w-3xl mx-auto">
              Compuesto líquido de alta densidad obtenido bajo estándares de ingeniería para impermeabilizar y preservar la integridad de madera, concreto y metales enterrados.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-4 border-primary/20 hover:border-primary transition-all duration-500 group">
              <Image
                src="/asfaltos/venta_alquitran.png"
                alt="Alquitrán Refinado JKO Asfalto"
                fill
            ...
            <div className="space-y-6">
              <h2 className="text-3xl lg:text-4xl font-black uppercase tracking-tight text-primary info-reveal">ALQUITRÁN REFINADO</h2>
              <p className="text-muted-foreground leading-relaxed text-lg info-reveal">
                ...
                El Alquitrán de JKO Asfalto es un compuesto líquido de alta densidad y viscosidad, reconocido en la ingeniería por su excepcional resistencia al agua y agentes corrosivos. Su capacidad de penetración superior en superficies porosas crea una barrera protectora que preserva la integridad de los materiales estructurales.
              </p>
              <div className="p-6 rounded-2xl bg-card border border-border info-reveal">
                <p className="text-sm font-medium italic">
                  "Es la solución de ingeniería predilecta para proyectos que enfrentan condiciones de humedad extrema, actuando como un fungicida natural para la madera y protector anticorrosivo para metales."
                </p>
              </div>
              ...
              <div className="info-reveal">
                <ProductCTA 
                  whatsappUrl={waUrl} 
                  productName="Alquitrán"
                  info="Garantizamos un alquitrán refinado de máxima impermeabilidad, bloqueando de forma absoluta la capilaridad y protegiendo sus estructuras contra el salitre."
                />
              </div>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-32 reveal-section">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Impermeabilidad", desc: "Bloquea de forma absoluta la capilaridad del suelo protegiendo contra el salitre.", icon: Droplets },
              { title: "Preservante", desc: "Actúa como fungicida natural para la madera, evitando ataque de insectos y pudrición.", icon: Bug },
              { title: "Anticorrosivo", desc: "Escudo químico que aísla los metales deteniendo de inmediato la oxidación.", icon: ShieldAlert },
              { title: "Alta Adherencia", desc: "Forma una capa flexible que se ancla firmemente sin desprenderse con el tiempo.", icon: CheckCircle2 }
            ].map((prop, idx) => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h2 className="text-4xl lg:text-5xl font-black uppercase tracking-tighter leading-none">
                Uso <span className="text-primary text-stroke-white">Especializado</span>
              </h2>
              <p className="text-background/70 text-lg">
                La técnica más robusta para preservación industrial y rural:
              </p>
              
              <ul className="space-y-4">
                {[
                  "Protección de Postes de Madera enterrados (Bases)",
                  "Sellado de Embarcaciones y Obras Marítimas Hidráulicas",
                  "Impermeabilización de Muros de Contención y Cimientos",
                  "Revestimiento protector de Tuberías y Fierro enterrado",
                  "Preservación de estructuras agrícolas de alta salinidad"
                ].map((item, idx) => (
              ...
              <div className="p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl">
                <div className="flex gap-4 items-center">
                  ...
                  <p className="text-sm text-background/80">
                    ...
                    Su viscosidad controlada es esencial para crear recubrimientos que no escurren en superficies verticales expuestas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
               <div className="space-y-4">
                 <div className="aspect-[4/5] relative rounded-2xl overflow-hidden shadow-2xl">
                   <Image src="/asfaltos/venta_alquitran.png" alt="Obra Alquitrán 1" fill className="object-cover transition-transform group-hover:scale-110 duration-700" />
                 </div>
               ...
               <div className="space-y-4 pt-12">
                 <div className="aspect-square relative rounded-2xl overflow-hidden shadow-2xl border border-primary/20">
                   <Image src="/asphalt_workers_premium_1775080184201.png" alt="Obra Alquitrán 2" fill className="object-cover" />
                 </div>
                 <div className="aspect-[4/5] relative rounded-2xl overflow-hidden shadow-2xl border border-primary/20">
                    <Image src="/quality_asphalt_premium_bg.png" alt="Obra Alquitrán 3" fill className="object-cover" />
                 </div>
               </div>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-32 reveal-section">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-black uppercase tracking-tighter mb-4">Garantía de Pureza</h2>
            <p className="text-muted-foreground">Entregas estandarizadas para el cumplimiento de cronogramas técnicos.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 text-center text-primary-foreground">
            {[
              { name: "Cilindro", size: "55 Galones", ideal: "Abastecimiento masivo para proyectos agrícolas e infraestructura.", icon: Box },
              { name: "Balde", size: "05 Galones", ideal: "Formato ergonómico para mantenimiento técnico de obras.", icon: Package },
              { name: "Galón", size: "Individual", ideal: "Precisión para detalles, reparaciones puntuales y hogar.", icon: Truck }
            ].map((p, idx) => (
      ...
      <section className="py-20 lg:py-40 bg-primary reveal-section overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl lg:text-7xl font-black uppercase text-primary-foreground mb-8 tracking-tighter leading-none">
            Protección impenetrable de larga vida
          </h2>
          <p className="text-primary-foreground/80 text-lg lg:text-xl mb-12 max-w-2xl mx-auto font-medium">
            Contacte con nuestros representantes comerciales para cotizaciones y asesoría en campo.
          </p>
          <Button
            asChild
            size="lg"
      ...
      <RelatedProducts currentProductId={13} />
